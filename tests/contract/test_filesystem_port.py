...
class TestFileSystemPortContract:
    ...
    def test_rename_nonexistent_file_raises_error(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_rename_to_existing_file_raises_error(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_list_markdown_files_empty_directory(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_file_exists_true_for_existing_file(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_file_exists_false_for_nonexistent_file(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_file_exists_false_for_directory(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
    ...
    def test_create_existing_directory_is_noop(
        self, filesystem_port: FileSystemPort, tmp_path: Path
    ) -> None:
