...
## Project: Linemark Node Templates System
...
- `LinemarkTemplateValidator`: Template validation
...
**File Locations**:
- Implementation: `/workspace/src/linemark/templates/`
- Specs: `/workspace/specs/007-node-templates-i/`
- Tests: `/workspace/tests/integration/templates/`
- CLI integration: `/workspace/src/linemark/cli/add.py`
...
- Implementation: `/workspace/src/linemark/wordcount/` (pending)
